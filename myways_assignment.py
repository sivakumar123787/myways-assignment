...
class signup:
    def __init__(self,name,gender,mobileNno,address,userid,password): #init is  constructor
        self.name=name
        self.gender=gender
...
obj=signup(name,gender,mobileNo,address,userid,password)  #object declartion
